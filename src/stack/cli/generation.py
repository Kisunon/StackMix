...
def main(args: Optional[List[str]] = None) -> None:
    ...
    parsed.output_dir = "../outputs/test"
    parsed.checkpoint = checkpoint_path
    parsed.base_adata = base_adata_path
    parsed.test_adata = test_adata_path
    parsed.genelist = genelist_path

    parsed.split_column = 'sm_name'
    parsed.batch_size = 16
    parsed.num_steps = 5
    parsed.prompt_ratio = 0.25
    parsed.context_ratio = 0.4
